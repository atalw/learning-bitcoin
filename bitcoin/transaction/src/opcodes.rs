...
impl From<&str> for All {
	fn from(s: &str) -> All {
		match s {
			...
			"OP_VERIF" => all::OP_VERIF,
			"OP_VERNOTIF" => all::OP_VERNOTIF,
			"OP_ELSE" => all::OP_ELSE,
			...
			"OP_TUCK" => all::OP_TUCK,
			"OP_CAT" => all::OP_CAT,
			"OP_SUBSTR" => all::OP_SUBSTR,
			"OP_LEFT" => all::OP_LEFT,
			"OP_RIGHT" => all::OP_RIGHT,
			"OP_SIZE" => all::OP_SIZE,
			"OP_INVERT" => all::OP_INVERT,
			"OP_AND" => all::OP_AND,
			"OP_OR" => all::OP_OR,
			"OP_XOR" => all::OP_XOR,
			"OP_EQUAL" => all::OP_EQUAL,
			"OP_EQUALVERIFY" => all::OP_EQUALVERIFY,
			"OP_RESERVED1" => all::OP_RESERVED1,
			"OP_RESERVED2" => all::OP_RESERVED2,
			"OP_1ADD" => all::OP_1ADD,
			"OP_1SUB" => all::OP_1SUB,
			"OP_2MUL" => all::OP_2MUL,
			"OP_2DIV" => all::OP_2DIV,
			...
			"OP_DIV" => all::OP_DIV,
			"OP_MOD" => all::OP_MOD,
			"OP_LSHIFT" => all::OP_LSHIFT,
			"OP_RSHIFT" => all::OP_RSHIFT,
